...
*Analysis Date: 2025-06-29 11:24:14*
...
|--------|-------|----------------|
| Count | 63 | Number of bets analyzed |
| Mean | 1.1173 | Average RTP multiple (>0.96 means profitable) |
| Median | 1.2060 | Middle RTP value (less affected by outliers) |
| Standard Deviation | 1.1315 | Measure of RTP volatility |
...
| Interquartile Range | 1.5760 | Range of the middle 50% of RTP values |
...
## RTP Distribution
The mean RTP of 1.1173x indicates that on average, each 1 unit bet returns 1.12 units. For comparison, a random selection strategy would be expected to return approximately $0.96 per $1 bet in the long run (due to bookmaker margins).

## Dataset Information
This analysis was performed on the UFC Model betting results dataset, which includes 63 bets. The model's predictions were compared against actual fight outcomes to evaluate RTP performance.
