...
*Analysis Date: 2026-02-08 17:26:22*
...
|--------|-------|----------------|
| Count | 165 | Number of bets analyzed |
| Mean | 0.9699 | Average RTP multiple (>0.96 means profitable) |
| Median | 1.1220 | Middle RTP value (less affected by outliers) |
| Standard Deviation | 1.1172 | Measure of RTP volatility |
...
| Interquartile Range | 1.5560 | Range of the middle 50% of RTP values |
...
## RTP Distribution
The mean RTP of 0.9699x indicates that on average, each 1 unit bet returns 0.97 units. For comparison, a random selection strategy would be expected to return approximately $0.96 per $1 bet in the long run (due to bookmaker margins).

## Dataset Information
This analysis was performed on the UFC Model betting results dataset, which includes 165 bets. The model's predictions were compared against actual fight outcomes to evaluate RTP performance.
